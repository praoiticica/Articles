...
# df = df[['Pclass', 'Sex', 'Age', 'SibSp', 'Parch', 'Embarked', 'Is_male',
#             'Embarked_code', 'Ticket_preffix', 'Companions', 'FamilySize',
#             'Title', 'is_noble', 'Fare_level', 'Fare_range','Cabin_label', 'Cabin_count', 'Age_group']]
...
app.layout = html.Div([
    html.H1('Titanic survival probability for Titanic_eng.csv dataset'),
